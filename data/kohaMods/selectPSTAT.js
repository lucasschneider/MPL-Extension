    ...
    if (addr.value !== "" && city.value !== "" && selectList !== null) {
      ...
      self.port.on("receivedCntySub", function (cntySub) {
        ...
        case "Middleton city":
       	  ...
       	  } else if (/.*(anderson a|beechwood c|[0-9]{3}[02468] branch s)|2[0-2][0-9]{2} bristol s|clark s|columbus d|coolidge c|cooper (a|c)|countryside d|cypress t|dohse c|(6[2-5][0-9][13579]|6[6-9][0-9]{2}) elmwood a|franklin a|gateway s|6[3-9][0-9]{2} ).*/i.test(matchAddr)) {
